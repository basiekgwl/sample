...
import utils.mybatis.controller.interfaces.IAbstractController;
import utils.mybatis.services.CustomJsonResponses;
import utils.mybatis.services.ErrorMsgDto;
import utils.mybatis.services.ExceptionData;
import utils.mybatis.services.JsonRespAttrName;
...
abstract class AbstractController implements IAbstractController {
    ...
    public ModelMap handleBadRequests(HttpServletRequest req, ConstraintViolationException ex) {
        ...
        ModelAndView mav = CustomJsonResponses.getModelAndView();
    ...
    public ModelMap handleMissingParam(HttpServletRequest req, MissingServletRequestParameterException ex) {
        ...
        log.debug(ErrorMsgDto.MISSING_PARAM_MSG);
        ...
        mav.addObject(JsonRespAttrName.CUSTOM_MSG, ErrorMsgDto.MISSING_PARAM_MSG);
        mav.addObject(JsonRespAttrName.PATH, req.getRequestURL());

        mav.setViewName(ErrorMsgDto.MISSING_PARAM_MSG);
